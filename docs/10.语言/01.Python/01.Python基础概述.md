...
![123](https://i.loli.net/2021/04/02/JQfKBm6scg852Ul.png)
...
-   Windows 7 系统 `一定要安装 Service Pack 1 补丁包` ，才能安装Python3.6 以后的版本
    ...
    ![白月黑羽Python3教程](https://i.loli.net/2021/04/02/SXW7LqaQ8fGzpMP.png)
...
![白月黑羽Python3教程](https://i.loli.net/2021/04/02/aiftc9WLQYN8yHm.png)


在下图这一步时，点击 Next 即可

![image](https://i.loli.net/2021/04/02/RQxCN1GvOtdVl35.png)
...
![image](https://i.loli.net/2021/04/02/vRmaxSH7inrP2ge.png)



![image](https://i.loli.net/2021/04/02/m9wcRsBo6CUi2ZX.png)
...
![image](https://i.loli.net/2021/04/02/uvFQEChs9lAaXd2.png)
...
![image](https://i.loli.net/2021/04/02/Ix63GCdoiSrFzkv.png)

然后，设置所有tab按键用4个空格替换，如下所示

![image](https://i.loli.net/2021/04/02/1JAY6sPMhKgbjOV.png)
...
![白月黑羽Python3教程](https://i.loli.net/2021/04/02/JQTjvDI96K8g5dy.png)
...
![白月黑羽Python3教程](https://i.loli.net/2021/04/02/KdNUz7816V3AG4h.png)



很多初学者会犯这个错误，他们居然在 `Python 交互式命令行中` 敲入 执行python程序的命令，像下面这样

![image](https://i.loli.net/2021/04/02/DKjnZGo3QIqVxaP.png)

...
<img src="https://pupperc.com/img/20210628101827.png" alt="image-20210506154411500" style="zoom:50%;" />
...
<img src="https://pupperc.com/img/20210628101833.png" alt="image-20210506154921820" style="zoom:50%;" />
...
![image-20210506160523719](https://pupperc.com/img/20210628101838.png)

#### 复杂数据类型

![image-20210506160604176](https://pupperc.com/img/20210628101841.png)
...
![image-20210506174637944](https://pupperc.com/img/20210628101846.png)

JS中， 表达式主要有：**算术表达式、关系表达式、逻辑表达式、赋值表达式、综合表达式**五种

<img src="https://pupperc.com/img/20210628101850.png" alt="image-20210506174858924" style="zoom:50%;" />
...
<img src="https://pupperc.com/img/20210628101855.png" alt="image-20210506180048230" style="zoom:50%;" />
...
<img src="https://pupperc.com/img/20210628101900.png" alt="image-20210506181134910" style="zoom:50%;" />
...
<img src="https://pupperc.com/img/20210628101905.png" alt="image-20210506181427340" style="zoom:50%;" />
...
![image-20210507143639014](https://pupperc.com/img/20210628101912.png)
...
-   调用函数非常简单，只需要在函数名称后书写 `（）` 即可。
    ...
    ![image-20210507144012073](https://pupperc.com/img/20210628101916.png)

### 3. 函数返回值

函数体内可以使用 `return `关键字表示 **“函数的返回值”**

![image-20210507144155887](https://pupperc.com/img/20210628101920.png)

### 4. 局部变量与全局变量

#### **局部变量**

![image-20210507144328702](https://pupperc.com/img/20210628101925.png)

#### 全局变量

![image-20210507144454931](https://pupperc.com/img/20210628101931.png)
...
![image-20210507144637917](https://pupperc.com/img/20210628101935.png)
